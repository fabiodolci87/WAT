...
/**
 * Activity that permits to see/add appointments to the trip
 *
 * @author Mirko
 */
public class ItineraryCoord extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_itinerary_coord);
    ...
    public void addComment(View v) {
        Intent i = new Intent(ItineraryCoord.this, AddItinerary.class);
        startActivity(i);
    }
    ...
    private void updateList() {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                //Here it is possible to do something when item pressed
            }
        });
    }
    ...
    public class LoadItinerary extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ItineraryCoord.this);
